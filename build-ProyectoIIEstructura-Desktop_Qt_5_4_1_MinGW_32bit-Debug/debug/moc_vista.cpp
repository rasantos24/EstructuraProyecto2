...
#include "../../ProyectoIIEstructura/vista.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Vista_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Vista_t qt_meta_stringdata_Vista = {
    {
QT_MOC_LITERAL(0, 0, 5), // "Vista"
QT_MOC_LITERAL(1, 6, 19), // "on_BtnSalir_clicked"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "Vista\0on_BtnSalir_clicked\0"
};
...
const QMetaObject Vista::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Vista.data,
      qt_meta_data_Vista,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Vista::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Vista.stringdata))
        return static_cast<void*>(const_cast< Vista*>(this));
